...
const LED_activity_desc_t LED_Noncritical_Activity      = {Blink,       LEDOFF,       120,    30};


volatile LED_state_rec_t LEDstate[LED_CNT] = {
  {Local_Control, &LED_On_Activity,   NULL, 0, 0, LEDCOLOR_BLUE,      _IPMI_BLLED     },
  {Local_Control, &LED_Off_Activity,  NULL, 0, 0, LEDCOLOR_GREEN,     _IPMI_LED1      },
  {Local_Control, &LED_Off_Activity,  NULL, 0, 0, LEDCOLOR_RED,       _IPMI_LED2      }
...
//  {Local_Control, &LED_Off_Activity, NULL, 0, 0, LEDCOLOR_GREEN, _GP_LED3}


static uint8_t IPMI_LED_callback(event evID, void* arg);
